 ...
 * 2019-05-11T16:12:56.355+08:00
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "EnglishChinese", 
                  wsdlLocation = "file:/D:/桌面/EnglishChinese.xml",
...
public class EnglishChinese extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/桌面/EnglishChinese.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EnglishChinese.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/桌面/EnglishChinese.xml");
        }
        WSDL_LOCATION = url;
    }
